...
const Nav = () => {
  ...
  return (
    <nav
      ...
      }  md:h-full w-full h-16 mx-auto fixed  left-0 bottom-0 duration-500 delay-200  ease-in-out z-50 md:flex md:flex-col  justify-between `}>
      ...
      <motion.ul
        className=" container mx-full md:pb-10 xl:pb-40 flex md:flex-col md:gap-12 md:pt-14 font-semibold text-xl  tracking-wider text-center items-center md:w-auto w-[96%] -mt-3 text-rose-50 -pl-2 md:mr-4 mx-auto "
        variants={container}
        initial="hidden"
        animate="visible">
        <motion.li
